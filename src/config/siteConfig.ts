...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "一个基于 Astro 和 Fuwari 主题的清新美观个人博客模板",
	...
	// 站点描述
	description:
		"奶片博客 是一款基于 Astro 框架和 Fuwari 模板开发的清新美观且现代化个人博客主题模板，专为技术爱好者和内容创作者设计。该主题融合了现代 Web 技术栈，提供了丰富的功能模块和高度可定制的界面，让您能够轻松打造出专业且美观的个人博客网站。",
